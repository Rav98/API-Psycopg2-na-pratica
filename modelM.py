...
class PedidoM():
    ...
    def cadastravendas(dadospedido, listaprodutos):
        dadospedido =[258952, 2, 2, datetime(2020, 9, 21, 0, 0), datetime(2020, 9, 22, 0, 0), datetime(2020, 9, 23, 0, 0), Decimal('36'), 'abc',]
